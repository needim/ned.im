...
date: "2024-02-05"
videoUrl: "https://player.bilibili.com/player.html?aid=752652004&bvid=BV12k4y197v6&cid=176424111&autoplay=0"

---

下面是一份详细的教程，介绍如何在 Windows、Linux、macOS 等平台上安装和配置 Ollama，以及如何下载与运行 DeepSeek R1 模型。本文重点补充了以下两部分内容：
