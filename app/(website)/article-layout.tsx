...
const TableOfContents = dynamic(
	() =>
		import("@/components/blocks/table-of-contents").then(
...
const TextSelectionQuote = dynamic(
	() =>
		import("@/components/blocks/text-selection-quote").then(
			(mod) => mod.TextSelectionQuote,
		),
	{ ssr: false },
);
