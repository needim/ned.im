	...
	return (
		...
		>
			...
			>
				...
				<span
					className={cn(
						"pointer-events-none absolute -left-[32rem] -top-[32rem] block size-[30rem] origin-bottom-right translate-x-0 translate-y-0 transform  opacity-10 transition-all duration-300 group-hover:-left-[7rem] group-hover:-top-[10rem]",
						"bg-zinc-300 dark:bg-zinc-800",
					)}
				/>
				<span
					className={cn(
						"pointer-events-none absolute bottom-0 right-0 mb-32 block size-[30rem] origin-top-left translate-x-[56rem] translate-y-[23rem] rotate-45 transform opacity-10 transition duration-300 group-hover:rotate-[100deg]",
						"bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-zinc-200 via-zinc-700 to-zinc-800",
					)}
				/>
				<span
					className={cn(
						"pointer-events-none absolute -bottom-0 -right-5 mb-32 block size-[30rem] origin-top-left translate-x-[56rem] translate-y-[23rem] rotate-45 transform opacity-10 transition duration-300 group-hover:rotate-[100deg] delay-75",
						"bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-zinc-200 via-zinc-700 to-zinc-800",
					)}
				/>
